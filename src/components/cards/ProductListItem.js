            ...
            <ul className='list-group'>
...

                {
                    category && <li className='list-group-item'>
                        Category{""}
                        <Link to={`/category/${category.slug}`} className='label label-default label-pill pull-xs-right text-info'>{category.name}</Link>
                    </li>
                }

                {
                    ...
                    <li className='list-group-item'>
                        ...
                        {subs.map((s) =>
                            <Link to={`/sub/${s.slug}`}
                                key={s._id}
                                className='label label-default label-pill pull-xs-right text-info'>
                                {s.name}
                            </Link>)}
                    </li>
                }
